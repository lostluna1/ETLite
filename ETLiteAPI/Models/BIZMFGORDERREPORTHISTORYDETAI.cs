...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "BIZ_MFGORDERREPORTHISTORYDETAI", DisableSyncStructure = true)]
	public partial class BIZMFGORDERREPORTHISTORYDETAI {
