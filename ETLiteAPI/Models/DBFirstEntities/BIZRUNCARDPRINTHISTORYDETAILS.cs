...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "BIZ_RUNCARDPRINTHISTORYDETAILS", DisableSyncStructure = true)]
	public partial class BIZRUNCARDPRINTHISTORYDETAILS {
