...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "BIZ_PRCGROUPDEFAULTFOROBJECTTY", DisableSyncStructure = true)]
	public partial class BIZPRCGROUPDEFAULTFOROBJECTTY {
