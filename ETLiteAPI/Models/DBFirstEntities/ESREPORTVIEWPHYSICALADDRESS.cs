...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "ES_REPORTVIEW_PHYSICALADDRESS", DisableSyncStructure = true)]
	public partial class ESREPORTVIEWPHYSICALADDRESS {
