...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "BIZ_SVCTAGSNPRINT", DisableSyncStructure = true)]
	public partial class BIZSVCTAGSNPRINT {
		...
		[JsonProperty, Column(Name = "BIZ_SVCTAGSNPRINTNAME", DbType = "VARCHAR2(36 BYTE)")]
		public string BIZSVCTAGSNPRINTNAME { get; set; }
