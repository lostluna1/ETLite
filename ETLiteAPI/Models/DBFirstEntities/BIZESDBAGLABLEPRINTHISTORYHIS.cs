...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "BIZ_ESDBAGLABLEPRINTHISTORYHIS", DisableSyncStructure = true)]
	public partial class BIZESDBAGLABLEPRINTHISTORYHIS {
