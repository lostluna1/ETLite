...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "BIZ_SVCTAGSNPRINTHISTORYDETAIL", DisableSyncStructure = true)]
	public partial class BIZSVCTAGSNPRINTHISTORYDETAIL {
