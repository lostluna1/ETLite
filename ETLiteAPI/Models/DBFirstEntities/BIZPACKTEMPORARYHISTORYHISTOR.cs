...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "BIZ_PACKTEMPORARYHISTORYHISTOR", DisableSyncStructure = true)]
	public partial class BIZPACKTEMPORARYHISTORYHISTOR {
