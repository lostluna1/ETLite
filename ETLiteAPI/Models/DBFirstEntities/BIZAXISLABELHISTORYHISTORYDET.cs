...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "BIZ_AXISLABELHISTORYHISTORYDET", DisableSyncStructure = true)]
	public partial class BIZAXISLABELHISTORYHISTORYDET {
