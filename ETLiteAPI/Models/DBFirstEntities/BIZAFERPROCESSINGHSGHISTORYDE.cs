...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "BIZ_AFERPROCESSINGHSGHISTORYDE", DisableSyncStructure = true)]
	public partial class BIZAFERPROCESSINGHSGHISTORYDE {
