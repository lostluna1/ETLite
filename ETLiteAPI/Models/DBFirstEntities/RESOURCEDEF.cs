...
public partial class RESOURCEDEF
{
    ...
    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string CHANGESTATUSID
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string CIOCHANNELADAPTERID
    {
        get; set;
    }

    [JsonProperty]
    public uint? CLEARANCELEVEL
    {
        get; set;
    }
    ...
    [JsonProperty]
    public uint? FACTORYLEVEL
    {
        get; set;
    }

    [JsonProperty]
    public uint? FACTORYLEVELINDEX
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string FEEDERCONTAINERID
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string FEEDERPLANBASEID
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string FEEDERPLANID
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string FEEDERSLOTID
    {
        get; set;
    }
    ...
    [JsonProperty]
    public uint? ISCAPACITY
    {
        get; set;
    }

    [JsonProperty]
    public uint? ISCONTAINERSTATUS
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string ISDEFECTMAPPINGID
    {
        get; set;
    }
    ...
    [JsonProperty]
    public uint? ISINCLUDEINOEE
    {
        get; set;
    }

    [JsonProperty]
    public uint? ISLINEIDENTIFIER
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string ISMFGORDERID
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "VARCHAR2(128 BYTE)")]
    public string ISMIOADAPTERNAME
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "VARCHAR2(128 BYTE)")]
    public string ISMIOCHANNELSOURCE
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "VARCHAR2(30 BYTE)")]
    public string ISMIOCHANNELSRCSERVERNAME
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string ISOEESETTINGSID
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string ISPRODUCTID
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string ISRECIPEBASEID
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string ISRECIPEID
    {
        get; set;
    }
    ...
    [JsonProperty]
    public uint? ISREUSETRACKINGCONTAINER
    {
        get; set;
    }

    [JsonProperty]
    public uint? ISSINGLEMFGORDER
    {
        get; set;
    }

    [JsonProperty]
    public uint? ISSINGLEPRODUCT
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string ISSPECID
    {
        get; set;
    }

    [JsonProperty]
    public uint? ISUSEPOSITION
    {
        get; set;
    }

    [JsonProperty]
    public uint? ISUSEPOSITIONSTATE
    {
        get; set;
    }

    [JsonProperty]
    public uint? ISVALIDATEQUEUE
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string LASTINTEGRATIONTXNID
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string LASTREVTXNID
    {
        get; set;
    }
    ...
    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string MAINTENANCECLASSID
    {
        get; set;
    }
    ...
    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string PRINTQUEUEID
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string PRODUCTIONSTATUSID
    {
        get; set;
    }
    ...
    public string RECIPEPATTERN
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string RESOURCEFAMILYID
    {
        get; set;
    }
    ...
    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string RESOURCESTATUSMODELID
    {
        get; set;
    }
    ...
    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string SETUPACCESSID
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string SMARTSCANRULEID
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "NUMBER(22)")]
    public decimal? THRUPUTFACTOR
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "NUMBER(22)")]
    public decimal? THRUPUTFACTOR2
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "VARCHAR2(40 BYTE)")]
    public string THRUPUTFACTORTYPE
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "VARCHAR2(40 BYTE)")]
    public string THRUPUTFACTORTYPE2
    {
        get; set;
    }
    ...
    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string TRAININGREQGROUPID
    {
        get; set;
    }
    ...
    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string WEBSERVICETRANSPORTID
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "CHAR(16 BYTE)")]
    public string WIPMSGDEFMGRID
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "NUMBER(22)")]
    public decimal? WORKINGRANGEMAX
    {
        get; set;
    }

    [JsonProperty, Column(DbType = "NUMBER(22)")]
    public decimal? WORKINGRANGEMIN
    {
        get; set;
    }
