...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "BIZ_AXISLABELPRINTINGHISTORYDE", DisableSyncStructure = true)]
	public partial class BIZAXISLABELPRINTINGHISTORYDE {
