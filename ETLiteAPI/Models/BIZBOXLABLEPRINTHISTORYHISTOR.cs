...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "BIZ_BOXLABLEPRINTHISTORYHISTOR", DisableSyncStructure = true)]
	public partial class BIZBOXLABLEPRINTHISTORYHISTOR {
