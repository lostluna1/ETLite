...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "ES_CADPRIMARY", DisableSyncStructure = true)]
	public partial class ESCADPRIMARY {

		[JsonProperty, Column(Name = "ES_CADPRIMARYID", DbType = "CHAR(16 BYTE)", IsPrimary = true, IsNullable = false)]
		...
		[JsonProperty, Column(Name = "ES_CADPRIMARYBASEID", DbType = "CHAR(16 BYTE)")]
