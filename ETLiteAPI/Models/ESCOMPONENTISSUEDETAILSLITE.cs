...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "ES_COMPONENTISSUEDETAILSLITE", DisableSyncStructure = true)]
	public partial class ESCOMPONENTISSUEDETAILSLITE {
