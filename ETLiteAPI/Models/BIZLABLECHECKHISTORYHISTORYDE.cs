...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "BIZ_LABLECHECKHISTORYHISTORYDE", DisableSyncStructure = true)]
	public partial class BIZLABLECHECKHISTORYHISTORYDE {
