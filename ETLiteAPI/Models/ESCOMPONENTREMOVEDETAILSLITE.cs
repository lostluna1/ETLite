...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "ES_COMPONENTREMOVEDETAILSLITE", DisableSyncStructure = true)]
	public partial class ESCOMPONENTREMOVEDETAILSLITE {
