...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "RV_DHRREWORK", DisableSyncStructure = true)]
	public partial class RVDHRREWORK {
		...
		[JsonProperty, Column(DbType = "VARCHAR2(40 BYTE)")]
		public string REWORKREASONNAME { get; set; }
