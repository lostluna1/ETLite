...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "BIZ_CONTAINERMAINTENANCEHISTOR", DisableSyncStructure = true)]
	public partial class BIZCONTAINERMAINTENANCEHISTOR {
