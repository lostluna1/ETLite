...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "RP_CRITICAL_SPEC_DASHBOARD_NEW", DisableSyncStructure = true)]
	public partial class RPCRITICALSPECDASHBOARDNEW {
