...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "BIZ_ATETESTDATAHISTORYDETAILS", DisableSyncStructure = true)]
	public partial class BIZATETESTDATAHISTORYDETAILS {
