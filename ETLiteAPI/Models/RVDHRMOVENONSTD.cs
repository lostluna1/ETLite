...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "RV_DHRMOVENONSTD", DisableSyncStructure = true)]
	public partial class RVDHRMOVENONSTD {
		...
		[JsonProperty, Column(Name = "TO_WORKFLOWSTEP", DbType = "VARCHAR2(46 BYTE)")]
