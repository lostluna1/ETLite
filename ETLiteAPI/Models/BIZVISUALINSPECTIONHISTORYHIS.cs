...
namespace ETLiteAPI.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "BIZ_VISUALINSPECTIONHISTORYHIS", DisableSyncStructure = true)]
	public partial class BIZVISUALINSPECTIONHISTORYHIS {
